...
function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <div><h2 className='mt-8 items-center text-lg font-bold'>Ecommerce</h2></div>
    ...
    >
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li>
            <a href="#" className="text-gray-700 transition hover:opacity-75"> Tops </a>
          </li>

          <li>
            <a href="#" className="text-gray-700 transition hover:opacity-75"> Jackets </a>
          </li>

          <li>
            <a href="#" className="text-gray-700 transition hover:opacity-75"> Shoes </a>
          </li>
        </ul>
      </div>
